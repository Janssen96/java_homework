          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1">内部调出单审核</span></td>
              </tr>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      <tr>
		  ...
		  <td  height="20" bgcolor="d3eaef" ><div align="center"><span class="STYLE10">申请用户</span></div></td>
      ...
      <c:forEach  items="${list}" var="bean">
       <tr>
        ...
        <a href="${url2 }update5?id=${bean.id }">审核</a>
