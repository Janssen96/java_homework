          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1">修改内部调出申请单</span></td>
              </tr>
            </table></td>
                   </tr>
        </table></td>
...
<form action="method!diaochuupdate2"  method="post" >
...
库房名:${kucun.kufang.name }&nbsp;&nbsp;&nbsp;区域名:${kucun.quyu.quyuming }&nbsp;&nbsp;&nbsp;可申请调度数量:${kucun.keshengqingkecun }
</td>
</tr>

<tr>
<td width="100" >调出库房区域</td>
<td width="300" > 
${bean.quyu1.quyuming }
...
<option value="${bean3.id }"  <c:if test="${bean3.id==bean.rukuliyou.id }">selected</c:if> >${bean3.liyou }</option>
</c:forEach>
</select>
</td>
</tr>
...
<td width="300" ><input type="text"  name="diaodushuliang"    value="${bean.diaodushuliang }" /></td>
</tr>
