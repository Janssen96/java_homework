          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1"> 审核入库单</span></td>
              </tr>
            </table></td>
                   </tr>
        </table></td>
...
<form action="method!rukuupdate6"  method="post" >
...
<td width="300" >
库房名:${bean.kufang.name }&nbsp;&nbsp;&nbsp;库房实际剩余数量:${bean.kufang.zuidashuliang-bean.kufang.shijirukushuliang }
