          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1"> 入库登记</span></td>
              </tr>
  ...
  <tr>
               ...
               <option value=""  >所有状态</option>
                <option value="未审核" <c:if test="${shenhezhuangtai=='未审核' }">selected</c:if> >未审核</option>
                 <option value="审核通过" <c:if test="${shenhezhuangtai=='审核通过' }">selected</c:if>>审核通过</option>
                  ...
                  <option value="成功入库" <c:if test="${shenhezhuangtai=='成功入库' }">selected</c:if>>成功入库</option>
               </select>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      <tr>
        ...
        <td  height="20" style="background-color: rgb(254, 237, 243);"><div align="center"><span class="STYLE10">入库单编号</span></div></td>

        <td  height="20" style="background-color: rgb(254, 237, 243);" ><div align="center"><span class="STYLE10">产品名</span></div></td>
        <td  height="20" style="background-color: rgb(254, 237, 243);" ><div align="center"><span class="STYLE10">库房名</span></div></td>
        <td  height="20" style="background-color: rgb(254, 237, 243);"><div align="center"><span class="STYLE10">区域名</span></div></td>

           <td  height="20"style="background-color: rgb(254, 237, 243);" ><div align="center"><span class="STYLE10">入库理由</span></div></td>
           
           <td  height="20" style="background-color: rgb(254, 237, 243);" ><div align="center"><span class="STYLE10">入库数量</span></div></td>
           <td  height="20" style="background-color: rgb(254, 237, 243);"><div align="center"><span class="STYLE10">入库单状态</span></div></td>
           <td  height="20" style="background-color: rgb(254, 237, 243);" ><div align="center"><span class="STYLE10">审核反馈</span></div></td>
           
            <td  height="20" style="background-color: rgb(254, 237, 243);" ><div align="center"><span class="STYLE10">添加时间</span></div></td>
         

  		 <td width="16%" height="20" style="background-color: rgb(254, 237, 243);" ><div align="center"><span class="STYLE10">操作</span></div></td>
      </tr>
      <c:forEach  items="${list}" var="bean">
       <tr>
        ...
        <c:if test="${bean.shenhezhuangtai=='审核未通过'}">
        ...
        <a href="${url2 }update?id=${bean.id }">修改 | 
         ...
         <a href="${url2 }delete?id=${bean.id }">删除|
          ...
          <c:if test="${bean.shenhezhuangtai=='审核通过'}">
           ...
           <a href="${url2 }delete2?id=${bean.id }">确认入库 
