          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1">出库登记</span></td>
              </tr>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      <tr>
        ...
        <td  height="20" bgcolor="d3eaef" ><div align="center"><span class="STYLE10">可申请出库数量</span></div></td>
      ...
      <c:forEach  items="${list}" var="bean">
       <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${bean.keshengqingkecun }</div></td>
        ...
        <a href="${url2 }add?id=${bean.id }">制定出库申请单</a>
