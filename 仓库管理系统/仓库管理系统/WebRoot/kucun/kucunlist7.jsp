          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1">动态库查询</span></td>
              </tr>
  ...
  <tr>
    		 ...
    		 <form action="${url }" method="post">
              产品名:
               ...
               <c:forEach items="${productlist}" var="bean1">
                <option value="${bean1.name }"<c:if test="${bean1.name==product }">selected</c:if> >${bean1.name }</option>
               </c:forEach>
               ...
               <c:forEach items="${kufanglist}" var="bean1">
                <option value="${bean1.name }"<c:if test="${bean1.name==kufang }">selected</c:if> >${bean1.name }</option>
               </c:forEach>
               ...
               <c:forEach items="${quyulist}" var="bean1">
                <option value="${bean1.quyuming }"<c:if test="${bean1.quyuming==product }">selected</c:if> >${bean1.quyuming }</option>
               </c:forEach>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      <tr>
		...
		<td  height="20" bgcolor="d3eaef" ><div align="center"><span class="STYLE10">区域</span></div></td>
