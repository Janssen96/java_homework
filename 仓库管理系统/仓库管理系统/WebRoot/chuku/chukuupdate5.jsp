...
<form action="method!chukuupdate6"  method="post" >
...
<td width="300" >${bean.chukushuliang }</td>
</tr>

<tr>
<td width="100" >经销商</td>
<td width="300" >${bean.jingxiaoshang } </td>
</tr>

<tr>
<td width="100" >联系电话</td>
<td width="300" >${bean.lianxidianhua } </td>
</tr>


<tr>
<td width="100" >出库单状态</td>
<td width="300" >
